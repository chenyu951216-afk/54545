...
class HybridTaiwanMarketNewsAdapter(NewsDataAdapter):
    ...
    def fetch(self, request: AdapterFetchRequest) -> AdapterFetchResult:
        ...
        if request.symbols and premium_window:
        ...
        merged = _merge_results(
            ...
            metadata={
                "provider": "hybrid",
                "scope": "mops_plus_finmind" if premium_window and request.symbols else "mops_primary",
                "premium_window_active": premium_window,
                "premium_provider_used": bool(request.symbols and premium_window),
            },
        )
